...
void CLCD_voidSendCommand (u8 ARG_u8Command)
{
	...
	MDIO_u8SetPinValue(CLCD_DATAPORT, CLCD_DATAPIN4, (ARG_u8Command&(0x01<<4))>>4);
	MDIO_u8SetPinValue(CLCD_DATAPORT, CLCD_DATAPIN5, (ARG_u8Command&(0x01<<5))>>5);
	MDIO_u8SetPinValue(CLCD_DATAPORT, CLCD_DATAPIN6, (ARG_u8Command&(0x01<<6))>>6);
	MDIO_u8SetPinValue(CLCD_DATAPORT, CLCD_DATAPIN7, (ARG_u8Command&(0x01<<7))>>7);
	/* Enable E_Pin (Sending Pulse)*/
	MDIO_u8SetPinValue(CLCD_CTRLPORT, CLCD_E_PIN, MDIO_HIGH);
	_delay_ms(2);
	MDIO_u8SetPinValue(CLCD_CTRLPORT, CLCD_E_PIN, MDIO_LOW);
	...
	MDIO_u8SetPinValue(CLCD_DATAPORT, CLCD_DATAPIN4, (ARG_u8Command&(0x01<<0))>>0);
	MDIO_u8SetPinValue(CLCD_DATAPORT, CLCD_DATAPIN5, (ARG_u8Command&(0x01<<1))>>1);
	MDIO_u8SetPinValue(CLCD_DATAPORT, CLCD_DATAPIN6, (ARG_u8Command&(0x01<<2))>>2);
	MDIO_u8SetPinValue(CLCD_DATAPORT, CLCD_DATAPIN7, (ARG_u8Command&(0x01<<3))>>3);
	/* Enable E_Pin (Sending Pulse)*/
	MDIO_u8SetPinValue(CLCD_CTRLPORT, CLCD_E_PIN, MDIO_HIGH);
	_delay_ms(2);
	MDIO_u8SetPinValue(CLCD_CTRLPORT, CLCD_E_PIN, MDIO_LOW);
...
void CLCD_voidSendData(u8 ARG_u8Data)
{
	...
	MDIO_u8SetPinValue(CLCD_DATAPORT, CLCD_DATAPIN4, (ARG_u8Data&(0x01<<4))>>4);
	MDIO_u8SetPinValue(CLCD_DATAPORT, CLCD_DATAPIN5, (ARG_u8Data&(0x01<<5))>>5);
	MDIO_u8SetPinValue(CLCD_DATAPORT, CLCD_DATAPIN6, (ARG_u8Data&(0x01<<6))>>6);
	MDIO_u8SetPinValue(CLCD_DATAPORT, CLCD_DATAPIN7, (ARG_u8Data&(0x01<<7))>>7);
	/* Enable E_Pin (Sending Pulse)*/
	MDIO_u8SetPinValue(CLCD_CTRLPORT, CLCD_E_PIN, MDIO_HIGH);
	_delay_ms(2);
	MDIO_u8SetPinValue(CLCD_CTRLPORT, CLCD_E_PIN, MDIO_LOW);
	...
	MDIO_u8SetPinValue(CLCD_DATAPORT, CLCD_DATAPIN4, (ARG_u8Data&(0x01<<0))>>0);
	MDIO_u8SetPinValue(CLCD_DATAPORT, CLCD_DATAPIN5, (ARG_u8Data&(0x01<<1))>>1);
	MDIO_u8SetPinValue(CLCD_DATAPORT, CLCD_DATAPIN6, (ARG_u8Data&(0x01<<2))>>2);
	MDIO_u8SetPinValue(CLCD_DATAPORT, CLCD_DATAPIN7, (ARG_u8Data&(0x01<<3))>>3);
	/* Enable E_Pin (Sending Pulse)*/
	MDIO_u8SetPinValue(CLCD_CTRLPORT, CLCD_E_PIN, MDIO_HIGH);
	_delay_ms(2);
	MDIO_u8SetPinValue(CLCD_CTRLPORT, CLCD_E_PIN, MDIO_LOW);
